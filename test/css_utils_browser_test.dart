...
main() {
  group('css', () {
    ...
    test('loadCss', () async {
      ...
      expect(document.head.querySelector('link[href="data/simple_stylesheet.css"]'), isNull);
      await loadStylesheet("data/simple_stylesheet.css");
      expect(document.head.querySelector('link[href="data/simple_stylesheet.css"]'), isNotNull);
